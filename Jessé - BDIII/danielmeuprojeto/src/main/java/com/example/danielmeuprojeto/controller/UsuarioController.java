package com.example.danielmeuprojeto.controller;
...
import com.example.danielmeuprojeto.domain.service.UsuarioService;

/*
____________________________________________
CRUD  |    Request             | Response
--------------------------------------------
Get:    ObterTodos -> Nao      | Usuarios[]
Get:    ObterporId -> ID       | Usuario
Post:   Cadastrar  -> Dto      | Dto
Put:    Atualizar  -> Id + Dto | Dto
Delete: Deletar    -> Id       | Void
